  ...
  const jobCategories: JobCategory[] = [
    {
      name: "Mechanic",
      image:
        "https://images.unsplash.com/photo-1743314777689-1bb71ae148ca?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA2ODl8MHwxfHNlYXJjaHwzfHxwcm9mZXNzaW9uYWwlMjBtZWNoYW5pYyUyMHdvcmtlciUyMGNsb3NlJTIwdXB8ZW58MHx8fHwxNzcxNDg0ODk1fDA&ixlib=rb-4.1.0&q=85",
    },
    {
      name: "Electrician",
      image:
        "https://images.pexels.com/photos/21812143/pexels-photo-21812143.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    },
    {
      name: "Plumber",
      image:
        "https://images.pexels.com/photos/6419128/pexels-photo-6419128.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    },
    {
      name: "Carpenter",
      image:
        "https://images.unsplash.com/photo-1688240817677-d28b8e232dd4?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjAzNTl8MHwxfHNlYXJjaHwxfHxjYXJwZW50ZXIlMjBtYW4lMjBzYW5kaW5nJTIwd29vZCUyMHByb2Zlc3Npb25hbHxlbnwwfHx8fDE3NzE0ODQ5MTJ8MA&ixlib=rb-4.1.0&q=85",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="md:col-span-7 flex flex-col justify-center">
              ...
              >
                Find Trusted Blue Collar{" "}
                <span className="text-primary">Artisans</span> in Abuja
              </h1>
              <p
                className="text-lg leading-relaxed text-slate-600 mb-8 max-w-xl"
                data-testid="hero-subtitle"
              >
                Connect with verified mechanics, electricians, plumbers, and
                more. Quality workmanship guaranteed.
              </p>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            <p className="text-sm font-medium tracking-wide uppercase text-slate-500 mb-3">
              Services
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center" data-testid="step-1">
              ...
              <p className="text-base text-slate-600 leading-relaxed">
                Browse our verified artisans by location and job type to find
            ...
            <div className="text-center" data-testid="step-2">
              ...
              <p className="text-base text-slate-600 leading-relaxed">
                Review profiles, ratings, and contact the artisan directly via
                phone to discuss your project.
              </p>
            </div>
            ...
            <div className="text-center" data-testid="step-3">
              ...
              <p className="text-base text-slate-600 leading-relaxed">
                After the job is done, share your experience by leaving a rating
                and review for others.
              </p>
            </div>
          </div>
        </div>
      ...
      {featuredArtisans.length > 0 && (
        <section
          className="py-20 md:py-32 bg-slate-50"
          data-testid="featured-artisans-section"
        >
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="text-center mb-16">
              <p className="text-sm font-medium tracking-wide uppercase text-slate-500 mb-3">
      ...
      <section className="py-20 md:py-32 bg-primary" data-testid="cta-section">
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Join BlueSans and connect with clients looking for your expertise.
