            ...
            src={
              artisan.photo_url
                ? artisan.photo_url.startsWith("/uploads")
                  ...
                  : artisan.photo_url
                : "https://images.unsplash.com/photo-1583182845142-55eb5b8fe184?w=600"
            }
            alt={artisan.name}
        ...
        <div className="p-6">
          <div className="flex items-start justify-between mb-3">
            <div>
              <h3
                ...
                data-testid={`artisan-name-${artisan.id}`}
              >
                {artisan.name}
              </h3>
              <p
                className="text-sm font-medium tracking-wide uppercase text-slate-500 mt-1"
                data-testid={`artisan-job-${artisan.id}`}
              >
                {artisan.job_type}
              </p>
            </div>
          ...
          <div className="space-y-2 mb-4">
            <div className="flex items-center gap-2 text-slate-600">
              ...
              <span
                className="text-sm"
                data-testid={`artisan-location-${artisan.id}`}
              >
                {artisan.location}
              </span>
            </div>
            <div className="flex items-center gap-2 text-slate-600">
              ...
              <span
                className="text-sm"
                data-testid={`artisan-phone-${artisan.id}`}
              >
                {artisan.phone}
              </span>
            </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-100">
            ...
            <span
              ...
              data-testid={`artisan-reviews-count-${artisan.id}`}
            >
